...
# ### Row
      self.btnClose = wx.Button(self.panel,-1,"Close", pos = (ColPixel[0],RowPixel[10]-5), size = ((ButtonWidth, ButtonHeight))) 
...
#        self.PartIDLabel = wx.StaticText(self.panel, -1, label = "Output folder: %s"%(self.VisitFolderName), pos = (ColPixel[3], RowPixel[0]))
   ...
   def OnClickedR2C2(self, event): 
      ...
      core.shellCall([sys.executable, "../WCST/WCST_v4.py", self.PartID.GetValue(), self.VisitFolderPath])#, self.PartID.GetValue(), self.VisitFolderPath])
