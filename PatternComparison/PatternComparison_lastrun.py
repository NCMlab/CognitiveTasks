...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath=u'/Users/jasonsteffener/Documents/GitHub/CognitiveTasks/PatternComparison/PatternComparison.psyexp',
...
Practice = data.TrialHandler(nReps=2, method='random', 
    ...
    trialList=data.importConditions('CognitiveTaskSetupFiles - PCtest.csv'),
