...
expName = u'TestingStaircase'  # from the Builder filename that created this script
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath=u'/Users/jasonsteffener/Documents/GitHub/CognitiveTasks/Testing/TestingStaircase.psyexp',
...
# Initialize components for Routine "CH"
CHClock = core.Clock()
text_2 = visual.TextStim(win=win, name='text_2',
    text=u'+',
    font=u'Arial',
    pos=(0, 0), height=45, wrapWidth=None, ori=0, 
    color=u'white', colorSpace='rgb', opacity=1,
    depth=0.0);
...
for thisTrial in trials:
    ...
    while continueRoutine:
        ...
        if key_resp_2.status == STARTED:
            ...
            if len(theseKeys) > 0:  # at least one key was pressed
                ...
                # was this 'correct'?
                if (key_resp_2.keys == str(u'right')) or (key_resp_2.keys == u'right'):
                    key_resp_2.corr = 1
                else:
                    key_resp_2.corr = 0
    ...
    # keep track of which components have finished
    CHComponents = [text_2]
    for thisComponent in CHComponents:
        if hasattr(thisComponent, 'status'):
            thisComponent.status = NOT_STARTED
