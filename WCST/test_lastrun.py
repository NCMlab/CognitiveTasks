...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/jason/Documents/GITHUBReposOutsideDropBox/CognitiveTasks/WCST/test_lastrun.py',
...
sound_1 = sound.Sound('4b.wav', secs=1.0, stereo=False)
sound_1.setVolume(1)
