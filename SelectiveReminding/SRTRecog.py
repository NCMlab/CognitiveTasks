...
text2 = visual.TextStim(win=win, name='text2',
    text=u'Word2',
    font=u'Arial',
    units='pix', pos=(0, 100), height=45, wrapWidth=None, ori=0, 
    color=u'white', colorSpace='rgb', opacity=1,
    depth=-3.0);
...
while continueRoutine:
    ...
    if mouse.isPressedIn(text1):
        text1.setColor((0, 128, 255), 'rgb255')
    if mouse.isPressedIn(text2):
        text2.setColor((0, 128, 255), 'rgb255')
...
thisExp.addData('mouse.clicked_text', mouse.clicked_text)
thisExp.nextEntry()
