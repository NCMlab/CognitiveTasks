...
expName = 'ResponseTimeTest'  # from the Builder filename that created this script
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/jasonsteffener/Documents/GitHub/CognitiveTasks/ResponseTimetesting/ResponseTimeTest_lastrun.py',
