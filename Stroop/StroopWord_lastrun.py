...
expName = u'StroopWord'  # from the Builder filename that created this script
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath=u'/Users/jason/Documents/GITHUBReposOutsideDropBox/CognitiveTasks/Stroop/StroopWord.psyexp',
