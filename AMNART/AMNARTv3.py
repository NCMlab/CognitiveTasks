...
Instr = visual.TextStim(win=win, name='Instr',
    text=u"This is a test of reading skills.\n\nYou will be shown one word at a time on the screen.\nI want you to read each word. \nThere are many words that you probably won't recognise, in fact most people don't know them, so just have a guess at these.\n\nPress any key to begin.\n  ",
    font=u'Arial',
...
InstComponents = [Instr, key_resp_3]
