...
expName = 'LexicalDecision'  # from the Builder filename that created this script
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath=u'/Users/jason/Dropbox/SteffenerColumbia/Projects/MyProjects/NeuralCognitiveMapping/CognitiveTasks/SemanticRichness/LexicalDecision.psyexp',
...
Intruct = visual.TextStim(win=win, name='Intruct',
    text=u'Press the left arrow for biological objects.\nPress the down arrow for non-biological objects.\n\nPress 5 to start.\nPress Escape at any time to interupt and stop the experiment.',
    font=u'Arial',
