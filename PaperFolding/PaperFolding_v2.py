...
from PIL import Image # used for finding teh size of images
...
# #################
FoldImageScale = 2
PaperFoldFolder = '../../PaperFoldingImages'
...
Prac1Feedback = visual.TextStim(win=win, name='Prac1Feedback',
    ...
    font=u'Arial',
    pos=(300, -100), height=30, wrapWidth=600, ori=0, 
    color=u'black', colorSpace='rgb', opacity=1,
    depth=0.0);
...
for thisTrial in trials:
    ...
    continueRoutine = True
    # update component parameters for each repeat
    StimImageFile = os.path.join(PaperFoldFolder, Stimulus)
    image.setImage(StimImageFile)
    im = Image.open(StimImageFile)
    width, height = im.size
    image.setSize([width*FoldImageScale, height*FoldImageScale])
    
    # image.setSize((556,144))
    CFig1.setImage(os.path.join(PaperFoldFolder,Choice1))
    CFig2.setImage(os.path.join(PaperFoldFolder,Choice2))
    CFig3.setImage(os.path.join(PaperFoldFolder,Choice3))
    CFig4.setImage(os.path.join(PaperFoldFolder,Choice4))
    CFig5.setImage(os.path.join(PaperFoldFolder,Choice5))
...
for thisTrial_2 in trials_2:
    ...
    continueRoutine = True
    # update component parameters for each repeat
    #image.setImage(os.path.join(PaperFoldFolder,Stimulus))
    StimImageFile = os.path.join(PaperFoldFolder, Stimulus)
    image.setImage(StimImageFile)
    im = Image.open(StimImageFile)
    width, height = im.size
