...
expName = 'MatricesWClock'  # from the Builder filename that created this script
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath=u'/Users/jasonsteffener/Documents/GitHub/CognitiveTasks/Matrices/MatricesWClock.psyexp',
...
for thisTrial in trials:
    ...
    # keep track of which components have finished
    trialComponents = [image, CFig1, CFig2, CFig3, CFig4, CFig5, CFIg6, Opt1, Opt2, Opt3, Opt4, Opt5, key_resp_2, CFig7, CFig8, Opt6, Opt7, Opt8, text_3]
    ...
    while continueRoutine:
        ...
        if text_3.status == STARTED:  # only update if drawing
            text_3.setText(timeText, log=False)
