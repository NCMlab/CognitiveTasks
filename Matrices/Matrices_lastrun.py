...
Opt1 = visual.TextStim(win=win, name='Opt1',
    text=u'1',
    font=u'Arial',
    pos=(-180, -30), height=40, wrapWidth=None, ori=0, 
    color=u'black', colorSpace='rgb', opacity=1,
    depth=-7.0);
Opt2 = visual.TextStim(win=win, name='Opt2',
    text=u'2',
    font=u'Arial',
    pos=(-30, -30), height=40, wrapWidth=None, ori=0, 
    color=u'black', colorSpace='rgb', opacity=1,
    depth=-8.0);
Opt3 = visual.TextStim(win=win, name='Opt3',
    text=u'3',
    font=u'Arial',
    pos=(120, -30), height=40, wrapWidth=None, ori=0, 
    color=u'black', colorSpace='rgb', opacity=1,
    depth=-9.0);
Opt4 = visual.TextStim(win=win, name='Opt4',
    text=u'4',
    font=u'Arial',
    pos=(270, -30), height=40, wrapWidth=None, ori=0, 
    color=u'black', colorSpace='rgb', opacity=1,
    depth=-10.0);
Opt5 = visual.TextStim(win=win, name='Opt5',
    text=u'5',
    font=u'Arial',
    pos=(-180, -180), height=40, wrapWidth=None, ori=0, 
    color=u'black', colorSpace='rgb', opacity=1,
    depth=-11.0);
...
Opt6 = visual.TextStim(win=win, name='Opt6',
    text=u'6',
    font=u'Arial',
    pos=(-30, -180), height=40, wrapWidth=None, ori=0, 
    color=u'black', colorSpace='rgb', opacity=1,
    depth=-15.0);
Opt7 = visual.TextStim(win=win, name='Opt7',
    text=u'7',
    font=u'Arial',
    pos=(120, -180), height=40, wrapWidth=None, ori=0, 
    color=u'black', colorSpace='rgb', opacity=1,
    depth=-16.0);
Opt8 = visual.TextStim(win=win, name='Opt8',
    text=u'8',
    font=u'Arial',
    pos=(270, -180), height=40, wrapWidth=None, ori=0, 
    color=u'black', colorSpace='rgb', opacity=1,
    depth=-17.0);
...
trials = data.TrialHandler(nReps=1, method='sequential', 
    ...
    trialList=data.importConditions(u'Matrices.csv', selection=u'[0]'),
...
trials_3 = data.TrialHandler(nReps=1, method='sequential', 
    extraInfo=expInfo, originPath=-1,
    trialList=data.importConditions(u'Matrices.csv', selection=u'[1]'),
...
trials_2 = data.TrialHandler(nReps=1, method='sequential', 
    extraInfo=expInfo, originPath=-1,
    trialList=data.importConditions(u'Matrices.csv'),
