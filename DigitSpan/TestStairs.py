...
expName = u'TestStairs'  # from the Builder filename that created this script
...
for thisTrial in trials:
    currentLoop = trials
    level = thisTrial
    print('Trial Number: %d, Level: %d'%(count,level))
    count += 1
    ...
    print('Correct: %d'%(key_resp_2.corr))
