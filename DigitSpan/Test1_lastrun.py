...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/jasonsteffener/Documents/GitHub/CognitiveTasks/DigitSpan/Test1_lastrun.py',
...
sound_1 = sound.Sound('NumberSounds2/1b.wav', secs=-1, stereo=True)
sound_1.setVolume(1)
...
sound_1.setSound('NumberSounds2/1b.wav')
