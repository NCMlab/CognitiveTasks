...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath=u'/Users/jason/Dropbox/SteffenerColumbia/Projects/MyProjects/NeuralCognitiveMapping/CognitiveTasks/DMSPsychopyFiles/DMSv2.psyexp',
...
for thisTrials1 in trials1:
    ...
    while continueRoutine and routineTimer.getTime() > 0:
        ...
        # *resp* updates
        if t >= 4.5 and resp.status == NOT_STARTED:
            # keep track of start time/frame for later
            resp.tStart = t
            ...
            event.clearEvents(eventType='keyboard')
        frameRemains = 4.5 + 3.5- win.monitorFramePeriod * 0.75  # most of one frame period left
