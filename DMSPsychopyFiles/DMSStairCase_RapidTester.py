...
# It cannot make two letter 9 trials in a row each with negative probes
...
# This try/catch/finally block is to get the program to dump its data even if there is a crash
try:
    ...
    for thisStep in staircase:
        ...
        print("The letter list at the beginning is: %s"%(tempLetterList))
        ...
        if bool(Probe):
            ...
            # Double check that the probe letter is not an L
