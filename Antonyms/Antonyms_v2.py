...
for thisPractice in Practice:
    ...
    Resp1.setText('1) %s'%(Choice1.ljust(NStringPad)))
    Resp2.setText('2) %s'%(Choice2.ljust(NStringPad)))
    Resp3.setText('3) %s'%(Choice3.ljust(NStringPad)))
    Resp4.setText('4) %s'%(Choice4.ljust(NStringPad)))
